    ...
    <footer className='footer'>
      ...
      <div className='lowerItems'>
        <div className='iconsContainer'>
          <a href='https://www.facebook.com/' target='blank'><FacebookIcon className='icons facebook' /></a>
          <a href='https://www.youtube.com/' target='blank'><YouTubeIcon className='icons youtube' /></a>
          <a href='https://www.twitter.com/' target='blank'><TwitterIcon className='icons twitter' /></a>
          <a href='https://www.pinterest.com/' target='blank' ><PinterestIcon className='icons pinterest' /></a>
          <a href='https://www.instagram.com/' target='blank'><InstagramIcon className='icons instagram' /></a>
        </div>
